...
public class Provider {
    ...
    private Provider(String user_name, String brand_name, String service_category, String service_identity, String personal_description,
                     ...
                     boolean always_available, boolean isGoogleAuth, float rating, int time_available_from, int time_available_to, float reach_in_distance, int number_of_ratings,
